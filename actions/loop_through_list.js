module.exports = {
  ...
  html: function (isEvent, data) {
    return `
<list-input onchange="glob.onChange1();" selectId="list" variableInputId="varName" variableContainerId="varNameContainer"></list-input>
...
<div style="width: 85%;">
  ...
  init: function () {
    ...
    glob.onChange1 = function () {
      const event = document.getElementById("list");
